...
Once you have opened the annotator, you an switch between individuals within your project or search using the bar at the top of the page.
...
Here you an view previous annotations, if allowed (you are not allowed to view other annotations when viewing an open project).
...
When in the *Annotate* tab, a blue annotation line will be visible. To annotate:

* Drag the end points of the axis to the centre & edge of the otolith
* Double-click anywhere on the axis to add an annuli marker
* Double-click an existing marker to remove it
* Drag existing markers to change their position
...
By default, markers will be added along the existing axis. If you want free-form marks, hold down ``Ctrl``:
...
Reader authority
    How highly regarded your reading will be. This mostly depends of you are one of the :ref:`administration/users:Species Experts` for the current species.
Comments
