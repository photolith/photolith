...
export function populateIndividualData (indData, elTableBody, tableMode = 'display', initFields, optionalFields) {
  if (!initFields && !optionalFields) {
...
export function populateSearchFilters (elContainer, metaFields, searchParams) {
  ...
  populateIndividualData(indData, elContainer, 'search-form', initFields, optionalFields);
}
